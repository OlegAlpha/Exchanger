...
public interface IUncacheService
{
    ...
    public Task<Response> ReguestToExchange(int userId, decimal amount, string from, string to);
    public Task<Response> GetUncachedFluctuation(DateTime start, DateTime end, string baseCurrency, List<string> uncahcedCurrencies);
